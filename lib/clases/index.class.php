...
<head>
	...
	<style type="text/css">@import url('.$this->host.'/sestue/lib/css/'.$this->estilo.'.css);</style>
	<style type="text/css">@import url('.$this->host.'/sestue/lib/css/marcos.css);</style>
	<style type="text/css">@import url('.$this->host.'/sestue/lib/css/css.css);</style>
	<script type="text/javascript" src="'.$this->host.'/sestue/lib/js/restringirCaracteres.js"></script>
	<script type="text/javascript" src="'.$this->host.'/sestue/lib/js/jquery.js"></script>
	<script type="text/javascript" src="'.$this->host.'/sestue/lib/js/js.js"></script>
<body>
<div id="marco">
	<div id="encabezado">
		<!---<h1>sestue</h1>--->
		<img src="/sestue/lib/img/gobierno.png" id="GobiernoBolivariano">
		<img src="/sestue/lib/img/campana_admirable.png" id="CampanaAdmirable" height="40">
		<img src="/sestue/lib/img/sestue.png" id="titulosestue">
	</div>
	<div id="menu">
		'.$menu.'
	</div>
