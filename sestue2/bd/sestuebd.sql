...
--
-- Servidor: localhost
-- Tiempo de generación: 08-08-2013 a las 11:38:55
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci COMMENT='Tabla que guarda la bitacora de los editores de t_proy_activ' AUTO_INCREMENT=2 ;
...
CREATE TABLE IF NOT EXISTS `t_preguntas_respuestas` (
  ...
  PRIMARY KEY (`c_id_pk`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci COMMENT='Tabla para guardar las preguntas/respuestas frecuentes' AUTO_INCREMENT=4 ;

--
-- Volcado de datos para la tabla `t_preguntas_respuestas`
--

INSERT INTO `t_preguntas_respuestas` (`c_id_pk`, `c_pregunta`, `c_respuesta`, `c_cap_perteneciente`) VALUES
(1, 'Como se hace un planteamiento del problema', 'Mediante la recoleccion de necesidades de un plantel', 1),
(2, 'Como se hace un planteamiento del problema', 'Mediante el levantamiento de informacion y requisitos', 1),
(3, 'Que es un objetivo general', 'Es el titulo del proyecto con un verbo', 1);
...
--
-- Volcado de datos para la tabla `t_proy_activ`
--

INSERT INTO `t_proy_activ` (`c_id_pk`, `c_cap_perteneciente`, `c_actividad`, `c_contenido`) VALUES
(1, 1, 'Titulo del proyecto', 'Desarrollo del software dirigido a ninos y ninas del plantel');
...
INSERT INTO `t_usuarios` (`c_cedula_pk`, `c_carnet_pk`, `c_nombres`, `c_apellidos`, `c_alias_pk`, `c_clave`, `c_palabra_secreta`, `c_rol`) VALUES
(1, 1, 'Administrador', 'Sistema', 'admin', '21232f297a57a5a743894a0e4a801fc3', 'Desarrollador', 5),
(2, 2, 'Profesor', 'Profesor', 'profesor', '793741d54b00253006453742ad4ed534', 'profesor', 4),
(23658013, 110300775, 'Ramon', 'Serrano', 'ramon', '266575d3c2b8a34f83817458f96152b1', 'ramon', 3);
