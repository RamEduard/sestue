<?php
	...
	{
		$menu = '
		<li><a href="stuei.php">Soporte Técnico I</a></li>
        <li><a href="stueii.php">Soporte Técnico II</a></li>
        <li><a href="stueiii.php">Soporte Técnico III</a></li>
		...
		';
		$html->constuirHtml("SESTUE | Soporte Técnico a Usuarios y Equipos III", 3, $mensaje, $_SESSION["NA"]);
	}
	else
	{
		echo "<script>
