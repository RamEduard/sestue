...
$contenido = '
    ...
    <div class="wrapper">
        ...
        <div class="body" style="margin-left:10%; margin-right:10%; width:80%">
                            ...
                            <div class="data-fluid editor">
                                <form id="actividad" action="../../controllers/crear.actividad.accion.php" method="post" autocomplete="off">
                                    <div class="row-form">
                                        ...
                                        <div class="span9"><input type="text" name="actividad[titulo]" title="Escriba el título de la actividad..." style="width: 50%;" required/></div>
                                    </div>
                                    <div class="row-form">
                                        <div class="span3">Capítulo de la actividad: </div>
                                        <div class="span9">
                                            <select name="actividad[capitulo]" class="select" style="width: 50%;" title="Seleccione el capítulo perteneciente de la actividad..." required>
    ...
    ';
$contenido .= "<script type='text/javascript' src='js/plugins/jquery/jquery-1.9.1.min.js'></script>
...
<?php
print $template->getPage('SESTUE | Crear actividad', $contenido);
?>
